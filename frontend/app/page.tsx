    ...
    <div className={styles.container}>
      <nav className={styles.navbar}>
        <div className={styles.logoGroup}>
          ...
          <span className={styles.logoText}>WebOffice</span>
        </div>
      ...
      <main className={styles.mainContent}>
        <div className={styles.heroText}>
          ...
          <p className={styles.heroSubtitle}>
            HWP/HWPX 웹 에디터. 언제 어디서나 브라우저에서 문서를 편집하고 개인 오브젝트 스토리지에 안전하게 보관하세요.
          </p>

          <div className={styles.authContainer}>
            <p className={styles.authLabel}>Get Started Securely:</p>
            <div className={styles.loginButtons}>
              <a className={`${styles.btn} ${styles.googleBtn}`} href="/oauth2/authorization/google">
              ...
              <a className={`${styles.btn} ${styles.discordBtn}`} href="/oauth2/authorization/discord">
        ...
        <div className={styles.heroVisual}>
          ...
          <img src="/hero_visual.png" alt="Abstract 3D Cloud Storage" className={styles.heroImage} />
        </div>
      </main>
    </div>
  );
